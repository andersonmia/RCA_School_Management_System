<%-- Created by IntelliJ IDEA. User: mia Date: 16.05.23 Time: 20:50 To change this template use File | Settings | File
    Templates. --%>
...
<div>
    ...
    <c:if test="${authenticatedUser !=null}">
        <b>
            <div id="profile">
                <div class="fullname">
                    <img src="icons/bts.png" id="bts" width="80px" height="80px"/>
...
<div id="middle" style="margin-top: 5vw">
    <c:if test="${authenticatedUser !=null}">
        <div class="beforeOptions">
            <div class="options">
                <a href="createstudent.php?page=createstudent" class="ba"
                   style="padding: 15px;display: flex;align-items: center;"
                   style="padding: 12px">
                    <img src="icons/student.png" height="30px" width="30px"/> Create New
                    Student
                </a>
            </div>
            <div class="search">
        ...
        <form action="liststudents.php?page=statusapproval" method="post">
            ...
            <div class="beforeTable">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${students}" var="student" varStatus="studentstatus">
                        <tr>
                            <td class="td">${student.getFirstName()}</td>
                            <td class="td">${student.getLastName()}</td>
                            <td class="td">${student.getDateOfBirth()}</td>
                            <td class="td">${student.getEmail()}</td>
                            <td class="td">${student.getPhoneNumber()}</td>
                            <td class="td">${student.isInternational()}</td>
                            <td class="td">${student.isPartTime()}</td>
                            <td class="td">${student.isRepeating()}</td>
