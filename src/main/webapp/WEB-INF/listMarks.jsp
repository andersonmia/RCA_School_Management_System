...
<div id="middle">
    <c:if test="${authenticatedUser !=null}">
        <div class="beforeOptions" style="margin-top: -20%">
            <div class="options">
                <a href="createmarks.php?page=createmarks" class="ba"
                   style="padding: 15px;display: flex;align-items: center;">
                    <img src="icons/marks.png" height="30px" width="30px"/> Create New Marks
                </a>
            </div>
            <div class="search">
        ...
        <form action="listmarks.php?page=statusapproval" method="post">
            ...
            <div class="beforeTable">
                <table>
                    <tr>
                        <td align="left">
                            <input type="text" size="15" maxlength="50" readonly="readonly"
                                   name="savedBy" id="savedBy" hidden="hidden"
                ...
                <table class="table">
                    ...
                    <c:forEach items="${marks}" var="mark" varStatus="markstatus">
                        <tr>
                            <td class="td">${mark.getStudent().getName()}</td>
                            <td class="td">${mark.getCourse().getName()}</td>
                            <td class="td">${mark.getScore()}</td>
