...
<div id="middle">
    <c:if test="${authenticatedUser !=null}">
        <div class="beforeOptions" >
            <div class="options">
                <a href="createparent.php?page=createparent" class="ba"
                   style="padding: 15px;display: flex;align-items: center;"
                   style="padding: 12px">
                    <img src="icons/parents.png" height="30px" width="30px"/> Create New
                    Parent
                </a>
            </div>
            <div class="search">
        ...
        <div class="beforeTable">
            ...
            <table class="table">
                ...
                <c:forEach items="${parents}" var="parent" varStatus="parentStatus">
                    <tr>
                        <td class="td">${parent.getId()}</td>
                        <td class="td">${parent.getFirstName()}</td>
                        <td class="td">${parent.getLastName()} </td>
                        <td class="td">${parent.getEmail()}</td>
                        <td class="td">${parent.getDateOfBirth()}</td>
                        <td class="td">${parent.getPhoneNumber()}</td>
                        <td class="td">
                            <c:choose>
