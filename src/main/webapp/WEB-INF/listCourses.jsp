...
<div id="middle">
    <c:if test="${authenticatedUser !=null}">
        <div class="beforeOptions" style="margin-top: -20%">
            <div class="options">
                <a href="createcourse.php?page=createcourse" class="ba"
                   style="padding: 15px;display: flex;align-items: center;">
                    <img src="icons/course.png" height="30px" width="30px"/> Create New Course
                </a>
            </div>
            <div class="search">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${courses}" var="csr" varStatus="csrstatus">
                        <tr>
                            ...
                            <td class="td">${csr.getCode()}</td>
                            <td class="td">${csr.getMinStudent()}</td>
                            <td class="td">${csr.getMaxStudent()}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
